 ...
 * @example
 * const raw =
 *  "web_scraper.py\r\n\r\n[Python Interpreter: /openreplica/poetry/openreplica-5O4_aCHf-py3.12/bin/python]\nopenreplica@659478cb008c:/workspace $ ";
 *
 * const parsed = parseTerminalOutput(raw);
 *
 * console.log(parsed.output); // web_scraper.py
 * console.log(parsed.symbol); // openreplica@659478cb008c:/workspace $
 */
